...
#ifndef RADIATIONMONTECARLOSFQEDTOOLKIT_H
#define RADIATIONMONTECARLOSFQEDTOOLKIT_H
...
//----------------------------------------------------------------------------------------------------------------------
class RadiationMonteCarloSFQEDtoolkit : public Radiation
{

public:

    //! Constructor for RadiationMonteCarlo
    RadiationMonteCarloSFQEDtoolkit( Params &params, Species *species, Random * rand  );

    //! Destructor for RadiationMonteCarlo
    ~RadiationMonteCarloSFQEDtoolkit();
